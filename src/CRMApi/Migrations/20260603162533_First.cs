        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_teams_developers_team_lead_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    developers_id = table.Column<string>(type: "text", nullable: false),
                    teams_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_developer_team", x => new { x.developers_id, x.teams_id });
                    table.ForeignKey(
                        name: "fk_developer_team_developers_developers_id",
                        column: x => x.developers_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_developer_team_teams_teams_id",
                        column: x => x.teams_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_developer_team_teams_id",
